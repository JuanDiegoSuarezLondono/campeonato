if(document.referrer.substring(0,48) != window.location.origin+'/interfaces/bienvenido.html' && document.referrer.substring(0,46) != window.location.origin+'/interfaces/partidos.html'){
